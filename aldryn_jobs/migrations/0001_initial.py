    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=models.deletion.CASCADE, verbose_name='job application', related_name='attachments', to='aldryn_jobs.JobApplication')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(on_delete=models.deletion.CASCADE, auto_created=True, parent_link=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=models.deletion.CASCADE, null=True, related_name='translations', to='aldryn_jobs.JobCategory', editable=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordering', models.IntegerField(verbose_name='ordering', default=0)),
                ('category', models.ForeignKey(on_delete=models.deletion.CASCADE, verbose_name='category', related_name='jobs', to='aldryn_jobs.JobCategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=models.deletion.CASCADE, null=True, related_name='translations', to='aldryn_jobs.JobOpening', editable=False)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='app_config',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, verbose_name='app configuration', help_text='Select appropriate app. configuration for this plugin.', null=True, to='aldryn_jobs.JobsConfig'),
        ...
        migrations.AddField(
            ...
            name='app_config',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, verbose_name='app configuration', null=True, related_name='categories', to='aldryn_jobs.JobsConfig'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='jobcategory',
        ...
        migrations.AddField(
            ...
            name='job_opening',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, to='aldryn_jobs.JobOpening', related_name='applications'),
            preserve_default=True,
        ),
    ]
